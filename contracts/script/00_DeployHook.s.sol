...
import {StableFlowHook} from "../src/hooks/StableFlowHook.sol";

/// @notice Mines the address and deploys the StableFlowHook.sol Hook contract
contract DeployHookScript is BaseScript {
    function run() public {
        ...
        (address hookAddress, bytes32 salt) =
            HookMiner.find(CREATE2_FACTORY, flags, type(StableFlowHook).creationCode, constructorArgs);
